...
<head>
	...
	<body>
		...
		<?php 
			...
			$sql_query1 = $conexao->query($sql_code1) or die ("Falha na execução dp código SQL: " . $conexao->error);

			$sql_code2 = "SELECT * FROM produtos WHERE tipo = 'PERIFÈRICO' ORDER BY idproduto DESC LIMIT 1";
			$sql_query2 = $conexao->query($sql_code2) or die ("Falha na execução dp código SQL: " . $conexao->error);
